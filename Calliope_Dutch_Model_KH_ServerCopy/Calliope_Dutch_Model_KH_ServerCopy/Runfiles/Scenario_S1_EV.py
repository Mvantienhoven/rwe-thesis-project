...
base_dir = Path.cwd()  
MODEL_FILE = base_dir / "Research_Runs" / "Scenario_S1.yaml"
...
tech_list =  ["pp_SMR_Hitachi_CHP_1","pp_SMR_Hitachi_CHP_2","pp_SMR_RollsRoyce_CHP_1","pp_SMR_RollsRoyce_CHP_2",
              "pp_SMR_Thorizon_CHP_1","pp_SMR_Thorizon_CHP_2","pp_SMR_Hitachi_CHP_3","pp_SMR_RollsRoyce_CHP_3", "pp_SMR_Thorizon_CHP_3"]


##FOR UNITS
from pyomo.environ import Var, Constraint, Binary, NonNegativeReals

def inject_chp_segment_switch(model, tech_list, tol=1e-6):
    """
...
if __name__ == "__main__":
    ...
    inject_chp_segment_switch(model, tech_list, tol=1e-6)
