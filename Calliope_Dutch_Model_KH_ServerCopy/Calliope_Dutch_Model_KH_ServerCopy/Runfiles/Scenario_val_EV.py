...
base_dir = Path.cwd()  
MODEL_FILE = base_dir / "Research_Runs" / "Validation.yaml"
OUTPUT_DIR = base_dir / "output" / "0.Validation"
LOG_VERBOSITY = "INFO" 
...
if __name__ == "__main__":
    ...
    yaml_file = create_versioned_filename("Val_EV_8K" + scenario_string, "yaml")
    model.save_commented_model_yaml(yaml_file)
    print(f" Fully merged model YAML saved to {yaml_file}")

    nc_file = create_versioned_filename("Val_EV_8K" + scenario_string, "nc")
