...
if __name__ == "__main__":
    ...
    yaml_file = create_versioned_filename("S1_KM_10K" + scenario_string, "yaml")
    model.save_commented_model_yaml(yaml_file)
    print(f" Fully merged model YAML saved to {yaml_file}")

    nc_file = create_versioned_filename("S1_KM_10K" + scenario_string, "nc")
    model.to_netcdf(str(nc_file))
